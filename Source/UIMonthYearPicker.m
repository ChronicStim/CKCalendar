...
-(CGFloat)componentWidthForComponent:(NSInteger)component
{
    ...
    switch (component) {
        case MONTH:
            width = self.bounds.size.width * 0.6f;
            break;
        case YEAR:
            width = self.bounds.size.width * 0.4f;
            break;
        default:
            width = 0;
            break;
...
-(UILabel *)labelForComponent:(NSInteger)component selected:(BOOL)selected
{
    ...
    label.font = [UIFont fontWithName:@"Arial-BoldMT" size:24.0f];
    label.adjustsFontSizeToFitWidth = YES;
    label.textColor = [UIColor cptPrimaryColor];
